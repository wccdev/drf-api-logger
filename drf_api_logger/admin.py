    ...
    class APILogsAdmin(admin.ModelAdmin, ExportCsvMixin):
        ...
        def added_on_time(self, obj):
            try:
                ...
                localtime = obj.added_on + timedelta(
                    minutes=self._DRF_API_LOGGER_TIMEDELTA
                )
        ...
        def changelist_view(self, request, extra_context=None):
            ...
            try:
                ...
                return response
            analytics_model = (
                filtered_query_set.values("added_on__date")
        ...
        def changeform_view(
            ...
            return super(APILogsAdmin, self).changeform_view(
